...
<head>
	...
	<cq:includeClientLib js="aetna.common"/>
	...
	<!--[if lt IE 9]>
		...
		<script src="/common/js/common-clientlibs/js/respond.min.js"></script>
        <link href="/common/css/common-clientlibs/css/ie8.css" rel="stylesheet" media="screen">
    <![endif]-->
	<!--[if lt IE 8]>
        <link href="/common/css/common-clientlibs/css/ie7.css" rel="stylesheet" media="screen">
     <![endif]-->
	
	<cq:include script="analytics-head.jsp" />

...
<cq:include path="topic-header-hc" resourceType="/apps/aetna/components/global/content/healthyCommitments/topicHeader"/>

<div class="template topic-template topic-template-hc">
